...
while True:
    ...
    if user_input in ['hi', 'hello']:
    ...
    elif user_input in ['how are you doing', 'how is your day', 'u good']:
        print(f'{bot_name}: I\'m doing great!')
    elif user_input in ['what is the weather', 'how is the weather',]:
        print(f'{bot_name}: Don\'t know!')
        ...
        try:
            ...
            print(f'{bot_name}: Oops! That doesn\'t seem like a valid number. Try again!')
    elif user_input in ['-', 'subtract', 'minus', 'sub']:
        print(f'{bot_name}: Sure! Let\'s do some addition! Please enter two numbers.')
        try:
            num1: float = float(input('First number: '))
            num2: float = float(input('Second number: '))
